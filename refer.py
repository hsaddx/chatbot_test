...
def get_conversation_chain(vetorestore,openai_api_key):
    ...
    ### 작업 지침:
    1. **문서 기반 사실만 '문서 참조'에 포함**:  
       문서에 포함된 내용은 **`문서 참조:`**로 시작하여 정확히 명시하십시오. 문서에 없는 추가적인 제안은 **`제안:`**으로 구분하여 작성하십시오.
    2. **구체성과 전략성 강조**:  
       마케팅 관점에서 실행 가능한 구체적 방안과 전략적 인사이트를 제공하십시오.  
    3. **답변 구분**:  
       - 문서에 포함된 사실만을 **`문서 참조:`**에 포함하십시오.  
       - 문서에 명시되지 않은 제안 및 전략은 **`제안:`**으로 구분하여 제공하십시오.
       - 각 섹션은 명확히 구분되도록 작성하십시오.
